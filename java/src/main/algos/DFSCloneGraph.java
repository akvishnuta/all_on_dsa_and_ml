...
public class DFSCloneGraph {
    ...
    public static void main(String[] args) {
        ...
        DFSCloneGraph solution = new DFSCloneGraph();

        Node clonedNode1 = solution.cloneGraph(node1);

        System.out.println("Original Node Value : " + node1.val);
        System.out.println("Cloned Node Value   : " + clonedNode1.val);
        ...
        System.out.println("Original Neighbors:");
        ...
        for (int i = 0; i < node1.neighbors.size(); i++) {
            System.out.println(
                    "Neighbor " +
                            node1.neighbors.get(i).val +
                            " same object? " +
                            (node1.neighbors.get(i) ==
                                    clonedNode1.neighbors.get(i))
            );
        }
